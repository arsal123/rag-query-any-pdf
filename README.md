...
- 📄 **PDF Ingestion**: Upload and process PDF documents into searchable vector embeddings. Used llama for chunking a big pdf document. Database is local so your data is saved local and secure.
